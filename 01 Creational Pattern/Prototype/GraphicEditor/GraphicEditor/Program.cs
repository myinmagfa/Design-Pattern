...
class program
{
    static void Main()
    {
        ...
        sh.AddShape("Circle", new Circle { x = 10, y = 20, Color = "Red", Radius = 5 });
        ...
        Console.WriteLine($"Circle Cloned with this params: Color= {((Circle)cloneCircle).Color}, Radius= {((Circle)cloneCircle).Radius}");
